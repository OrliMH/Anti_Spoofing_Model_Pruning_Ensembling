...
import sys 
sys.path.append("/home/disk2/live_detect/week3/week3code-CVPR19-Face-Anti-spoofing/process")
from utils import *
import cv2
from data_helper import *


class FDDataset(Dataset): # color ir depth 都是3通道的，见explore_channels，老师当时说后两个是单通道，他讲的不对。
    ...
    def set_mode(self, mode, fold_index):
        ...
        if self.mode == 'test':
            ...
            #self.log.write('set dataset mode: val')
            #self.log.write('num_data:{}'.format(self.num_data))
    ...
    def __getitem__(self, index):
        ...
        if self.mode == 'train':
            ...
            #self.log.write("self.val_list:{}\n".format(self.val_list[index]))
        ...
        #if self.mode == 'val':
         #   self.log.write("after cv2.imread:{}\n".format(image.shape))
        image = cv2.resize(image,(RESIZE_SIZE,RESIZE_SIZE))
        #if self.mode == 'val':
         #   self.log.write("after resize:{}\n".format(image.shape))
        ...
        if self.mode == 'train':
            ...
            return torch.FloatTensor(image), test_id # 36 3 32 32
